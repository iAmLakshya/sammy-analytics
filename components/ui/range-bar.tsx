          ...
          <TooltipContent>
            <div className="text-xs">
              ...
              <div className="grid grid-cols-2 gap-x-3 gap-y-0.5 mt-1">
                ...
                <span className="tabular-nums">{min.toFixed(1)}{unit}</span>
                <span className="text-muted-foreground">Median:</span>
                <span className="tabular-nums">{median.toFixed(1)}{unit}</span>
                <span className="text-muted-foreground">Max:</span>
                <span className="tabular-nums">{max.toFixed(1)}{unit}</span>
                {average !== undefined && (
                  <>
                    <span className="text-muted-foreground">Avg:</span>
                    <span className="tabular-nums">{average.toFixed(1)}{unit}</span>
                  </>
                )}
              </div>
            </div>
