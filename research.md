...
```css
--chart-1: oklch(0.82 0.14 55); /* Light amber */
--chart-2: oklch(0.72 0.18 45); /* Medium orange */
--chart-3: oklch(
  0.6552 0.2334 34.2495
); /* Primary orange (matches --primary) */
--chart-4: oklch(0.55 0.18 30); /* Deep orange */
--chart-5: oklch(0.45 0.14 25); /* Dark amber */
```
